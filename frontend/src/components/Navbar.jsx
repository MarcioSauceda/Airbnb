    ...
    <header className="sticky top-0 z-40 border-b bg-white/80 backdrop-blur">
      <div className="container flex items-center justify-between py-3">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm">
          <button className="relative pb-2 font-medium text-gray-900">
            Alojamientos
        ...
        <div className="flex items-center gap-2">
          <Link to="#" className="hidden sm:block rounded-full px-3 py-2 text-sm hover:bg-gray-100">
          ...
          {token ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <Link to="/register" className="hidden sm:block rounded-full bg-black px-3 py-2 text-sm text-white hover:opacity-90">
                Crear cuenta
              </Link>
            </div>
          )}
